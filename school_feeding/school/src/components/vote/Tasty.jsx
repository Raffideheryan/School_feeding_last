...
export const Tasty = () => {
  ...
  return (
    <div className="lifestyle">
      ...
      <h1>«Համեղ և առողջարար. իմ սիրելի առողջարար բաղադրատոմսը» անվանակարգ</h1>
      <div className="names">
      ...
      <div className="game">
        <div className="concept">
          <h2>
          Առողջ բաղադրատոմսի հայեցակարգը
          </h2>

          <span>
          Բաղադրատոմսի անվանումը և մանրամասն
      ...
      <div className="leaflet">
        ...
        <div className="info">
          <span>Նախագծված թռուցիկը պետք է ներառի.</span>
      ...
      <div className="video">
        ...
        <div className="info">
          ...
          <ul>
            ...
            <li>բաղադրատոմսի պատրաստման գործընթացը,</li>
