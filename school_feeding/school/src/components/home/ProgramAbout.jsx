...
const ProgramAbout = () => {
  ...
  const onclickPdfFile = () => {
    fetch("http://127.0.0.1:8000/download_pdf/")
      .then((res) => {
        if (res.ok) {
          return res.blob();
        } else {
    ...
    <div className="programAbout">
            ...
            <div className="modalProgramAbout">
              ...
              <div className="modalProgramAboutContent">
                ...
                <h2>
                  ...
                  ակտիվությունը և առողջ սնվելու գաղափարը հանրայնացնելու համար և
                  ներկայացնել այն:
                </h2>
                <div
                ...
                >
                  ...
                  <h3>
                    Մասնակից թիմը պետք է ներկայացնի խաղի նախագիծ, որը կպարունակի
                    հետևյալ նյութերը...
                  </h3>
                  <div className="countsMembers">
                    <div className="membersOne">
                      ...
                      <div>
                        <span>
                          Չափանիշներին ավելի մանրամասն ծանոթանալու համար խնդրում
                          ենք ներբեռնել մրցույթի պայմանները{" "}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          {modalAboutProgram.program2 && (
            <div className="modalProgramAbout">
              ...
              <div className="modalProgramAboutContent">
                ...
                <h2>
                  «Բացահայտելով առողջ ապրելակերպի աշխարհը. մեր հետազոտությունը»․
                  իրականացնել առողջ ապրելակերպի սկզբունքների վերաբերյալ
                  հետազոտություն  ևվ ներկայացնել այն:
                </h2>
                <div
                  className={`modalProgramAboutContentTextBlock ${
                    all ? "heightNone" : "height"
                ...
                >
                  ...
                  <ol>
                    <li>
                      Ընտրեք թեմա, ընտրեք առողջ ապրելակերպի որոշակի ուղղություն,
                      որը ձեզ հետաքրքրում է (օրինակ՝ առողջ սնվելը, ֆիզիկական
                      վարժություններ կամ մտավոր բարեկեցություն):
                    </li>
                    <li>
                      Ի՞նչ հարցեր են ջեզ մոտ առաջանում ձեր ընտրած թեմայի
                      վերաբերյալ: Օրինակ, եթե ընտրում եք առողջ սնվելը, կարող եք
                      հարցնել. «Որո՞նք են ամեն օր միրգ և բանջարեղեն ուտելու
                      առավելությունները»:
                    </li>
                    <li>
                      Որոշեք այն աղբյուրները, որոնցից կարող եք գտնել ձեր հարցերի
                      պատասխանները: Դուք կարող եք տեղեկություններ փնտրել
                      վստահելի աղբյուրներից, ինչպիսիք են գրքերը, հոդվածները կամ
                      հեղինակավոր կայքերը: Օգտվեք գրադարանից կամ խնդրեք ձեր
                      ուսուցչին ձեզ խորհուրդ տալ:
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      մարդկանց որոշակի խմբի հետ (ձեր դպրոցի, համայնքի), կարող եք
                      հարցազրույց վերցնել մի քանի պատահական մարդկանցից:
                    </li>
                    <li>
                      ...
                      տեղեկատվությունը: Ի՞նչ եզրակացության է դա բերում։ Ներառեք
                      հետաքրքիր փաստեր, վիճակագրություն և ցանկացած մեջբերում,
                      որը ձեզ հետաքրքիր է թվում:
                    </li>
                  </ol>
          ...
          {modalAboutProgram.program3 && (
            <div className="modalProgramAbout">
              ...
              <div className="modalProgramAboutContent">
                ...
                <h2>
                  «Իմ առողջ համայնքը» ստեղծել  իրենց քաղաքում/գյուղում/դպրոցում
                  առողջ ապրելակերպի գաղափարին նպաստող սոցիալական նախագիծ ևվ
                  ներկայացնել այն:
                </h2>
                <div
                  className={`modalProgramAboutContentTextBlock ${
                ...
                >
                  ...
                  <ol>
                    <li>
                      ...
                      առողջությունը և առողջապահական խնամքի հասանելիությունը: Դա
                      կարող է լինել շինարարական ծրագիր, կանաչապատում,
                      միջոցառումների կազմակերպում, վերապատրաստման և իրազեկման
                      արշավներ:
                    </li>
                    <li>
                      Մտածեք մի այնպիսի նախագիծ, որը կբավարարի ձեր համայնքի
                      կարիքները և կբարելավի «առողջ բաղադրիչը» նրա ապրելակերպում:
                    </li>
                    <li>Համոզվեք, որ ձեր նախագիծը հնարավոր է իրականացնել:</li>
                    <li>
                      Տեղացի փորձագետներից (առողջապահության ոլորտի մասնագետներ,
                      սննդաբաններ կամ համայնքային կազմակերպություններ)
                      ուղղորդում խնդրեք (մենթորություն, խորհրդատվություն)՝
                      պատկերացումներ ձեռք բերելու և ձեր նախագծի ճշգրտությունն ու
                      համապատասխանությունը ապահովելու համար:
                    </li>
                  </ol>
            ...
            <div className="modalProgramAbout">
              ...
              <div className="modalProgramAboutContent">
                ...
                <h2>
                  ...
                  առողջ ուտեստի կամ նախաճաշի բաղադրատոմս, եփել այն և գործընթացը
                  ներկայացնել:
                </h2>
                <div
                  className={`modalProgramAboutContentTextBlock ${
                ...
                >
                  ...
                  <ol>
                    <li>
                      ...
                      (ընտրեք այնպիսի բաղադրիչնեը, որոնք հեշտությամբ հասանելի են
                      Հայաստանում):
                    </li>
                    <li>
                  ...
                  <div className="tasySpan">
                    <p>
                      Առողջ  է այն սնունդը, որը մարդուն տալիս է անհրաժեշտ բոլոր
                      սննդանյութերը՝ առողջ մնալու, լավ զգալու և մեծ քանակությամբ
                      էներգիա ունենալու համար:
                    </p>
                    <p>
                      Տապակելու եղանակը, որպես կանոն, չի կարող օգտագործվել առողջ
                      ուտեստ պատրաստելիս՝ ավելացված կալորիաների և յուղի կլանման
                      բարձր մակարդակի հետ կապված առողջության համար հնարավոր
                      ռիսկերի պատճառով: Փոխարենը մտածեք պատրաստման առողջ 
                      եղանակների մասին՝ շոգեխաշելը, եփելը, թխելը, ցածր
                      ջերմաստիճանի տակ երկար եփելը և այլն։
                    </p>
                  </div>
      ...
      <div className="introducion">
        <div className="introducion-info">
          ...
          <p>
            «Առողջ ապրելակերպի դեսպան մրցույթը» այն դպրոցականների համար է, ովքեր
            հետաքրքրված են առողջ ապրելակերպով և ստեղծագործական աշխատանքով։ 
          </p>
          <p>
            Այս մրցույթի շրջանակներում մասնակիցներին առաջարկվում է առողջ
            ապրելակերպի գաղափարի վրա հիմնված նախագծեր ստեղծել: Լավագույն
            նախագծերի հեղինակները հնարավորություն կստանան մի ողջ շաբաթ անցկացնել
          ...
          <p className="participateRulle">
            Մրցույթին կարող են մասնակցել 5-8-րդ դասարանների աշակերտներն ամբողջ
            Հայաստանից։
          </p>
          <h4>Մրցույթի փուլերը</h4>
          <p className="participateRulle">
            <span>Փուլ 1. Գրանցում :</span> Թիմերից ակնկալվում գրանցվել
            մասնակցության համար մինչև 2024 թվականի ապրիլի 30-ը (23:59):
          </p>
          ...
          <p className="participateRulle">
            ...
            կանոնների։  Առցանց քվեարկության վերջնաժամկետն է 2024 թվականի հունիսի
            30-ը (23:59):
          </p>
        </div>
        <div className="introducion-info">
          ...
          <p>
            ...
            առողջապահության նախարարությունը, ՀՀ կրթության, գիտության, մշակույթի
            և սպորտի նախարարությունը, ՄԱԿ-ի Պարենի համաշխարհային ծրագիրը,
            «Դպրոցական սնունդ և երեխաների բարեկեցություն» հիմնարկը, ՌԴ Ճյուղային
            սննդի ինստիտուտը։
          </p>
        </div>
        <div className="introducion-info">
          ...
          <p>
            ...
            հոգանոց թիմերով։ Ամեն թիմում կարող է ընդգրկվել 4 հոգի՝ 5-6 կամ
            7-8-րդ դասարանների տարիքային խմբերից։
          </p>
          <p>
            Յուրաքանչյուր դպրոցից կարող է մասնակցել ամենաշատը 2 թիմ՝ մեկական թիմ
            յուրաքանչյուր տարիքային խմբից (օրինակ՝ 1 թիմ կազմված  5-6
            դասարանցիներից, և 1 թիմ կազմված  7-8 դասարանցիներից):
          </p>
        </div>
        ...
        <div className="introducion-info">
          <h4 className="exercise">Հայտադիմումներին ներկայացվող պահանջները</h4>
          ...
          <ul className="decimal">
            <li>
              ...
              լուսանկարներ/գծագրեր և մանրակերտ եռածալ բուկլետ և տեսանյութ։
            </li>
            <li>
              «Բացահայտելով առողջ ապրելակերպի աշխարհը. մեր հետազոտությունը» և
              «Իմ առողջ համայնքը» նախագծերի հայտադիմումը պետք է պարունակի
              հայեցակարգ, շնորհանդես, լուսանկարներ, եռածալ բուկլետ և տեսանյութ:
            </li>
          </ul>

          <p className="participateRulle">
            Նախագծի հիմնական գաղափարները պետք է ձևավորված լինեն եռածալ բուկլետի
            մեջ՝ PDF ձևաչափով (նյութը տպելու կարիք չկա): Այս պահանջը վերաբերում
            է բոլոր չորս անվանակարգերին։ Այս ձևաչափը նյութը կազմակերպված կերպով
        ...
        <div className="introducion-info">
          ...
          <ul className="disc">
            ...
            <li>
              հասակակիցների և ավելի կրտսեր դպրոցականների համար նախագծի ընկալման
              մատչելիությունը,
            </li>
            <li>
            ...
            <li>
              ստեղծարարությունը (ստեղծագործական մոտեցում, արտասովոր լուծումների
              կիրառում),
            </li>
            <li>
              ինտերակտիվ ներկայացումը, նախագծի պատրաստման ընթացքում ժամանակակից
        ...
        <div className="introducion-info">
          <h4>ԳՆԱՀԱՏՈՒՄԸ</h4>
          <span>Ընտրող հանձնաժողովը և գնահատումը</span>
          <p>
          ...
          <p>
            ...
            քվեարկության կանոնների։  Առցանց քվեարկության վերջնաժամկետն է 2024
            թվականի մայիսի 31-ը (23:59):
          </p>

          <p className="evaluate">
            Ըստ ընտրող հանձնաժողովի գնահատականի և առցանց քվեարկության
            արդյունքների՝ կորոշվեն 4 լավագույն նախագծերը (1 թիմ յուրաքանչյուր
            անվանակարգից, ընդամենը 16 հոգի) մինչև 2024 թվականի հունիսի 4-ը:
          </p>
        </div>
        ...
        <div className="introducion-info">
          ...
          <p className="evaluate">
            ...
            քվեարկության փուլին. 5-ական թիմ 4 անվանակարգերից (ընդամենը՝ 20 թիմ):
            Պարգևատրման արարողությունը կանցկացվի Երևանում՝ բացօթյա էքսպո
          ...
          <p>
            ...
            տեղերը զբաղեցրած մասնակիցները կպարգևատրվեն խրախուսական մրցանակներով
            և պատվոգրերով։
          </p>
        </div>
      </div>
