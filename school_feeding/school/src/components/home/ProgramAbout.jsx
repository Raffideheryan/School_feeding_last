      ...
      <div className="programAbout">
        ...
        <div className="introducion">
          <div className="introducion-info">
            ...
            <p className="participateRulle">
              <span>Փուլ 1. Գրանցում:</span>  Իրենց մասնակցության մասին հայտնելու համար թիմերից ակնկալվում լրացնել Գրանցման ձևը։
            </p>
            ...
            <p className="participateRulle">
              ...
              Թիմերից ակնկալվում է ներկայացնել իրենց նախագծերը՝ համապատասխան ձևաչափով լրացնելով հայտադիմումը՝ մինչև հունիսի 17-ը: 
            </p>
            <p className="participateRulle">
              <span>Փուլ 3. Որակավորման փուլ: </span>Ընտրող հանձնաժողովը կդիտարկի ստացված նախագծերը և կհայտարարի յուրաքանչյուր անվանակարգում 5 լավագույններին: 

            </p>
            <p className="participateRulle">
              <span>Փուլ 4. Քվեարկության փուլ։ </span>
              Որակավորված նախագծերը կհրապարակվեն մրցույթի կայքում, որից հետո Հայաստանի բոլոր դպրոցականները կկարողանան առցանց քվեարկել իրենց նախընտրած նախագծի համար։
            </p>
          </div>
          <div className="introducion-info">
          ...
          <div className="introducion-info">
            ...
            <ul className="decimal">
              ...
              <li>
                ...
                հայեցակարգ, շնորհանդես, լուսանկարներ, եռածալ բուկլետ և
                տեսանյութ:
              </li>
            </ul>

            <p className="participateRulle">
              Նախագծի հիմնական գաղափարները պետք է ձևավորված լինեն եռածալ
              բուկլետի մեջ՝ PDF ձևաչափով (նյութը տպելու կարիք չկա): Այս պահանջը
