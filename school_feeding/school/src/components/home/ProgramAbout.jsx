    ...
    <div className="programAbout">
            ...
            <div className="modalProgramAbout">
              ...
              <div className="modalProgramAboutContent">
                ...
                <h2>
                  ...
                  առողջ ապրելակերպի գաղափարին նպաստող սոցիալական նախագիծ և
                  ներկայացնել այն:
                </h2>
                <div
                  className={`modalProgramAboutContentTextBlock ${
                ...
                >
                  ...
                  <ol>
                    <li>
                      ...
                      (ընտրեք այնպիսի բաղադրիչներ, որոնք հեշտությամբ հասանելի են
                      Հայաստանում):
                    </li>
                    <li>
      ...
      <div className="introducion">
        <div className="introducion-info">
          ...
          <p className="participateRulle">
            <span>Փուլ 1. Գրանցում:</span> Թիմերից ակնկալվում է գրանցվել
        ...
        <div className="introducion-info">
          ...
          <p>
            ...
            յուրաքանչյուր տարիքային խմբից (օրինակ՝ 1 թիմ կազմված  5-6-րդ
        ...
        <div className="introducion-info">
          ...
          <p className="participateRulle">
            ...
            է բոլոր չորս անվանակարգերին։ Այս ձևաչափով նյութը կազմակերպված կերպով
